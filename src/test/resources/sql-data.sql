...
INSERT INTO `customer_table` (`first_name`, `surname`) VALUES ('jordan', 'harrison');
INSERT INTO `customer_table` (`first_name`, `surname`) VALUES ('raul', 'ciobanu');
INSERT INTO `customer_table` (`first_name`, `surname`) VALUES ('mark', 'owen');
INSERT INTO `customer_table` (`first_name`, `surname`) VALUES ('matei', 'tudor');




INSERT INTO `item_table` (`name`, `value`) VALUES ('mouse', 3.5);
INSERT INTO `item_table` (`name`, `value`) VALUES ('glass', 1.5);
INSERT INTO `item_table` (`name`, `value`) VALUES ('spoon', 2.5);
